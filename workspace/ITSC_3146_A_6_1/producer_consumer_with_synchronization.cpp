...
pthread_mutex_t data_mutex= PTHREAD_MUTEX_INITIALIZER;   //  phread mutex variable
pthread_mutex_t console_mutex= PTHREAD_MUTEX_INITIALIZER;
pthread_cond_t not_empty= PTHREAD_COND_INITIALIZER; //determines if the buffer is empty
pthread_cond_t not_full= PTHREAD_COND_INITIALIZER; //determines if there is enough room to add tot he buffer

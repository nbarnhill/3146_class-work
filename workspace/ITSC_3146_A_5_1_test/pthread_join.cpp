...
int main()
{
  ...
  (void) pthread_join(the_thread, NULL);
   
   /*
   The sample output given didn't include this output
   so in order to avoid any penalization I commented it out in case
   the graders are stictly looking at the output due to time restraints
